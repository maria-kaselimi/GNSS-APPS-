 ...
 */
FARPROC WINAPI GnssPlotGuiDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = GnssPlotGuiDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = GnssPlotGuiDelayLoadWin32FailureHook;
#endif
