 ...
 */
FARPROC WINAPI GnssGetGuiDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = GnssGetGuiDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = GnssGetGuiDelayLoadWin32FailureHook;
#endif
